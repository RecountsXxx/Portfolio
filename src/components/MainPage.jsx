            ...
            <div className="container-fluid">
                <div id="about" className="about-us d-flex justify-content-center mt-5">
                    <div className="about-div">
                        <h1 className="text-opacity-75 text-white flow-around">Bogdan Kapriyan <span
                            className="text-opacity-75 text-white ">(Junior Back-end developer)</span></h1>
                        <h4 className="text-white-50 flow-around">Hello! My name is Bogdan Kapriyan and I am a beginner
                            backend developer. My specialization is the creation and support of the server side of web
                            applications. I have experience with various technologies and tools that allow me to create
                            efficient and scalable web services. My skills include using programming languages ​​such as
                            PHP and JavaScript as well as frameworks such as Laravel, NodeJS and ExpressJS. I have
                            experience with various database management systems such as MySQL, PostgreSQL and MariaDB.
                            This allows me to create and optimize queries to effectively interact with the data. In
                            addition to my backend development experience, I also have frontend development skills. I
                            have knowledge of React frameworks, Angular which allows me to create interactive user
                            interfaces. I am also familiar with CSS frameworks such as Bootstrap which allows me to
                            create stylish and responsive web pages using modern design techniques. I am constantly
                            working on improving my skills and following the latest trends in the world of backend
                            development. I am ready to take on new challenges and participate in exciting projects where
                            I can apply my knowledge and creativity.</h4>
                    </div>
